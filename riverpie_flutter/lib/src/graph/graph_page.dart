...
class RiverpieGraphPage extends StatefulWidget {
  final bool showWidgets;

  const RiverpieGraphPage({
    this.showWidgets = false,
    super.key,
  });

  @override
  State<RiverpieGraphPage> createState() => _RiverpieGraphPageState();
}

class _RiverpieGraphPageState extends State<RiverpieGraphPage> with Riverpie {
  late _Graph _graph;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Riverpie Graph'),
        actions: [
          PopupMenuButton(
            itemBuilder: (context) {
              return [
