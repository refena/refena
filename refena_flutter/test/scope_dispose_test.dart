...
class _ImplicitContainerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return RefenaScope(
      child: _NotifierWidgetAccessor((ref) => onImplicitRef(ref)),
    );
  }
}
...
final _disposeProvider =
    StateProvider((ref) => false, debugLabel: 'disposeProvider');

class _NotifierWidgetAccessor extends StatelessWidget {
  final void Function(Ref)? onRef;

  const _NotifierWidgetAccessor([this.onRef]);

  @override
  Widget build(BuildContext context) {
    onRef?.call(context.ref);
    return Text(context.ref.watch(_disposableProvider).toString());
  }
}
